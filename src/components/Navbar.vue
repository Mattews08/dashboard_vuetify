          ...
          <v-list>
              ...
              <v-list-item  router to="/">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle align="center">Doutor</v-list-item-subtitle>
                  </v-list-item-content>  
              </v-list-item>
             </v-list>
             <v-list flat>
              <v-list-item  router to="/">
                   <v-list-item-content>
                      ...
                      <v-list-item-subtitle align="center">Contato</v-list-item-subtitle>
                  </v-list-item-content>  
              </v-list-item>
             </v-list>
             <v-list flat>
               <v-list-item  router to="/">
                  <v-list-item-content>
                      ...
                      <v-list-item-subtitle align="center">Rastreador</v-list-item-subtitle>
                  </v-list-item-content>  
              </v-list-item>
             </v-list>
